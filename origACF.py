...
def pressView():
     ...
     if len(classes) > 0:
          ...
          if classes[index].getmaxsessionnum() == Ellipsis:
               #temp.append("This class will last indefinitely")
               main.setLabel("class_dur","This class will last indefinitely")
          else:
               #temp.append("Running for " + str(classes[index].getmaxsessionnum()) + " sessions")
               main.setLabel("class_dur","Running for " + str(classes[index].getmaxsessionnum()) + " sessions")
...
def refreshView():
     ...
     if len(classes) > 0:
          ...
          main.setLabel("class_name",classes[classDataDisplay].getname())
          if classes[classDataDisplay].getmaxsessionnum() == Ellipsis:
               #temp.append("This class will last indefinitely")
               main.setLabel("class_dur","This class will last indefinitely")
          else:
               #temp.append("Running for " + str(classes[classDataDisplay].getmaxsessionnum()) + " sessions")
               main.setLabel("class_dur","Running for " + str(classes[classDataDisplay].getmaxsessionnum()) + " sessions")
...
def viewMenu():
     ...
     main.addLabel("class_dur",str(currentMax),1,0,4)
     main.setSticky("")
